...
const NPM_DEPRECATION_MESSAGE = 'Reverse Agent has switched from npm to native installer. Run `reverse-agent install` or see https://docs.anthropic.com/en/docs/claude-code/getting-started for more options.';
