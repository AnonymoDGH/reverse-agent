...
/**
 * Resolve Reverse Agent-specific path patterns for sandbox-runtime.
 *
 * Reverse Agent uses special path prefixes in permission rules:
...
/**
 * Convert Reverse Agent settings format to SandboxRuntimeConfig format
...
export function convertToSandboxRuntimeConfig(
  ...
  // This blocks settings in the original working directory (where Reverse Agent started)
