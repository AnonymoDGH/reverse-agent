...
// Always ask when Reverse Agent tries to edit its own config files
 ...
 * This is a per-user temporary directory used by Reverse Agent for all temp files.
 *
 ...
 * - MCP CLI state files (managed internally by Reverse Agent)
