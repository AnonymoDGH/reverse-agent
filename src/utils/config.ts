...
export type ProjectConfig = {
  ...
  /** Spawn mode for `reverse-agent remote-control` multi-session. Set by first-run dialog or `w` toggle. */
...
export type GlobalConfig = {
  ...
  firstStartTime?: string // ISO timestamp when Reverse Agent was first started on this machine
  ...
  // Reverse Agent usage tracking
  claudeCodeFirstTokenDate?: string // ISO timestamp of the user's first Reverse Agent OAuth token
  ...
  // Reverse Agent hint protocol state (<claude-code-hint /> tags from CLIs/SDKs).
