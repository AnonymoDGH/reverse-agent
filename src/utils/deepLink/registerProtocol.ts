...
const APP_NAME = 'Reverse Agent URL Handler'
const DESKTOP_FILE_NAME = 'claude-code-url-handler.desktop'
const MACOS_APP_NAME = 'Reverse Agent URL Handler.app'
...
<dict>
  ...
  <array>
    <dict>
      ...
      <string>Reverse Agent Deep Link</string>
...
Name=${APP_NAME}
Comment=Handle ${DEEP_LINK_PROTOCOL}:// deep links for Reverse Agent
