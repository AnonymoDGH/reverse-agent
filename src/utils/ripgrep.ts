...
const getRipgrepConfig = memoize((): RipgrepConfig => {
  ...
  // El source map no incluía los binarios vendor/ripgrep. La distribución
  // multiplataforma de VS Code resuelve el ejecutable correcto mediante su
  // paquete opcional específico de plataforma.
