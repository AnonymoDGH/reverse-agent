...
export function ModelPicker(t0) {
  ...
  const t16 = headerText ?? "Switch between models (Qwen and configured providers). Applies to this session and future Reverse Agent sessions. For other model names, specify with --model.";
  let t17;
  if ($[42] !== t16) {
