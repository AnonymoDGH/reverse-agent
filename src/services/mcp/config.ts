 ...
 * `reverse-agent mcp add` expressed higher intent than a connector toggled in the web UI.
 *
...
/**
 * Get Reverse Agent MCP configurations (excludes claude.ai servers from the
 ...
 * @returns Reverse Agent server configurations with appropriate scopes
 */
