...
/**
 * Fetch the user's first Reverse Agent token date and store in config.
 * This is called after successful login to cache when they started using Reverse Agent.
 */
