...
const DEFAULT_PREFIX = `You are Reverse Agent, a multi-provider terminal coding agent.`
const AGENT_SDK_CLAUDE_CODE_PRESET_PREFIX = `You are Reverse Agent, a multi-provider terminal coding agent, running within the Claude Agent SDK.`
