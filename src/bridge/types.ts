...
/** Full error printed when `reverse-agent remote-control` is run without auth. */
...
/**
 * How `reverse-agent remote-control` chooses session working directories.
...
export type BridgeConfig = {
   ...
   * instead of creating a new one. Used by `reverse-agent remote-control
