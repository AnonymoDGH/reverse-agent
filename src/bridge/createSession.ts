 ...
 *
 * Used by both `reverse-agent remote-control` (empty session so the user has somewhere to
 ...
 * explicit client action. Both `reverse-agent remote-control` (standalone bridge) and the
